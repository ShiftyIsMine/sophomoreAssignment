...
import kr.ac.kopo.shifty.bookmarket.repository.OrderProRepository;
...
public class OrderProService {
    ...
    public Page<Order> listAll(int pageNum, String sortField, String sortDirection) {
        int pageSize = 5;
        Pageable pageable = PageRequest.of(pageNum-1, pageSize, sortDirection.equals("asc")? Sort.by(sortField).ascending():Sort.by(sortField).descending());
